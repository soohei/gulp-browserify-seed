...
gulp.task 'browserify', ->
  b = browserify
    entries: [ "#{SRC_DIR}/assets/scripts/main.coffee" ]
...
gulp.task 'watch', ->
  ...
  gulp.watch "#{SRC_DIR}/assets/scripts/**/*.coffee", ['browserify']
...
gulp.task 'build', ->
  runSequence [ 'copyHtml', 'sass', 'browserify', 'concat-vendor.js', 'concat-vendor.css' ]
